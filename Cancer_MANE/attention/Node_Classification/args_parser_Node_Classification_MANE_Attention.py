...
def get_parser():
    ...
    parser.add_argument('--read_pair', action='store_true',
    ...
    parser.add_argument('--dataset', nargs='?', default='Cancer/',
                        help='Input graph path ')
    ...
    parser.add_argument('-anlp','--att_node_label_path', nargs='?', default='data/labels/node/',
